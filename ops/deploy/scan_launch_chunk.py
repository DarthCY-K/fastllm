#!/usr/bin/env python
# SCAN launcher CHUNK-WINDOW variant (2026-09-17): 生产 argv（overlay-fix 代码）+ 端口改 8081 + SCAN_ENV / SCAN_ARGV 覆盖。
...
os.environ['PYTHONPATH'] = '/home/ai-agent/builds/fastllm-video-venv/lib/python3.13/site-packages'
