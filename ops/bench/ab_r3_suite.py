#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""AB r3 suite — same-window prod(8080) vs r3(8081) comparison.
...
Usage: ab_r3_suite.py <base_url> <out.json> <tag>
"""
...
OUT = sys.argv[2] if len(sys.argv) > 2 else "/home/ai-agent/builds/upgrade-test/ab-r3.json"
